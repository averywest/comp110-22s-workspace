...
def test_only_evens_empty() -> None:
    """Unit test for edge case for even function definition."""
    numbers: list[int] = []
    assert only_evens(numbers) == []


def test_only_evens_odds() -> None:
    """Unit test for use case for even function definition."""
...
def test_sub_empty() -> None:
    """Unit test for edge case for subset list created."""
    numbers_two: list[int] = []
    assert sub(numbers_two, 1, 3) == []


def test_sub_correct() -> None:
    """Unit test use case for subset list created."""
...
def test_concat_empty() -> None:
    """Unit test edge case for two lists combined."""
    first_list: list[int] = []
...
def test_concat_single_items() -> None:
    """Unit test use case for two lists combined."""
